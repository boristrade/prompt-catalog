...
Переведён интерфейс, но **не сами промты**: их 49, и с примерами результата это 86 КБ текста. Машинный перевод специализированных промтов на пять языков испортил бы главное, ради чего люди приходят. Каталог остаётся русским и переводится отдельной задачей — как и описания сервисов на странице инструментов.
