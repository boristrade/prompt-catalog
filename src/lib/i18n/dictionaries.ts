...
const ru = {
  ...
  subscribe: {
    title: "Писать, когда появятся новые промты?",
    text: "Каталог пополняется пачками по два-три десятка. Оставьте почту — пришлю письмо, когда будет следующая.",
    placeholder: "Ваша почта",
    button: "Подписаться",
    ok: "Готово. Напишу, когда каталог пополнится.",
    already: "Этот адрес уже в списке — всё в силе.",
    invalid: "Проверьте адрес: похоже, в нём опечатка.",
    error: "Не получилось сохранить. Попробуйте ещё раз чуть позже.",
    promise: "Только о новых промтах, не чаще пары раз в месяц. Отписаться можно из любого письма в один клик.",
    leaveTitle: "Отписка",
    leaveDone: "Готово, больше писем не будет.",
    leaveFailed: "Ссылка не подошла. Возможно, вы уже отписались — или адрес открыли не целиком.",
    leaveBack: "На главную",
  },
  catalog: {
    promptWord: {
      one: "промт",
...
const en: Dictionary = {
  ...
  subscribe: {
    title: "Want a note when new prompts land?",
    text: "The catalogue grows in batches of two or three dozen. Leave your email and I'll write when the next one arrives.",
    placeholder: "Your email",
    button: "Subscribe",
    ok: "Done. I'll write when the catalogue grows.",
    already: "That address is already on the list — nothing to do.",
    invalid: "Check the address: looks like a typo.",
    error: "Couldn't save that. Try again in a moment.",
    promise: "Only about new prompts, a couple of times a month at most. One click to unsubscribe from any email.",
    leaveTitle: "Unsubscribe",
    leaveDone: "Done, no more emails.",
    leaveFailed: "That link didn't work. You may have unsubscribed already — or the address was cut short.",
    leaveBack: "Home",
  },
  catalog: {
    promptWord: {
...
const fr: Dictionary = {
  ...
  subscribe: {
    title: "Un mot quand de nouveaux prompts arrivent ?",
    text: "Le catalogue s'enrichit par lots de vingt ou trente. Laissez votre e-mail et je vous écris au prochain.",
    placeholder: "Votre e-mail",
    button: "S'abonner",
    ok: "C'est fait. Je vous écris au prochain lot.",
    already: "Cette adresse est déjà dans la liste — rien à faire.",
    invalid: "Vérifiez l'adresse : elle semble contenir une faute.",
    error: "Impossible d'enregistrer. Réessayez dans un instant.",
    promise: "Uniquement sur les nouveaux prompts, deux fois par mois au maximum. Désabonnement en un clic depuis n'importe quel e-mail.",
    leaveTitle: "Désabonnement",
    leaveDone: "C'est fait, plus d'e-mails.",
    leaveFailed: "Ce lien n'a pas fonctionné. Vous êtes peut-être déjà désabonné — ou l'adresse a été tronquée.",
    leaveBack: "Accueil",
  },
  catalog: {
    promptWord: {
...
const uk: Dictionary = {
  ...
  subscribe: {
    title: "Писати, коли зʼявляться нові промти?",
    text: "Каталог поповнюється пачками по два-три десятки. Залиште пошту — надішлю листа, коли буде наступна.",
    placeholder: "Ваша пошта",
    button: "Підписатися",
    ok: "Готово. Напишу, коли каталог поповниться.",
    already: "Ця адреса вже в списку — усе лишається в силі.",
    invalid: "Перевірте адресу: схоже, в ній помилка.",
    error: "Не вдалося зберегти. Спробуйте ще раз трохи згодом.",
    promise: "Тільки про нові промти, не частіше кількох разів на місяць. Відписатися можна з будь-якого листа в один клік.",
    leaveTitle: "Відписка",
    leaveDone: "Готово, більше листів не буде.",
    leaveFailed: "Посилання не підійшло. Можливо, ви вже відписалися — або адресу відкрито не повністю.",
    leaveBack: "На головну",
  },
  catalog: {
    promptWord: {
      one: "промт",
...
const de: Dictionary = {
  ...
  subscribe: {
    title: "Bescheid geben, wenn neue Prompts kommen?",
    text: "Der Katalog wächst in Schüben von zwei bis drei Dutzend. Hinterlassen Sie Ihre E-Mail — ich schreibe beim nächsten.",
    placeholder: "Ihre E-Mail",
    button: "Abonnieren",
    ok: "Fertig. Ich schreibe, sobald der Katalog wächst.",
    already: "Diese Adresse steht schon auf der Liste — alles bleibt, wie es ist.",
    invalid: "Prüfen Sie die Adresse: sieht nach einem Tippfehler aus.",
    error: "Konnte nicht gespeichert werden. Versuchen Sie es gleich noch einmal.",
    promise: "Nur zu neuen Prompts, höchstens ein paar Mal im Monat. Abmelden mit einem Klick aus jeder E-Mail.",
    leaveTitle: "Abmeldung",
    leaveDone: "Fertig, keine E-Mails mehr.",
    leaveFailed: "Der Link hat nicht funktioniert. Vielleicht sind Sie schon abgemeldet — oder die Adresse wurde abgeschnitten.",
    leaveBack: "Zur Startseite",
  },
  catalog: {
    promptWord: {
      one: "Prompt",
...
const pl: Dictionary = {
  ...
  subscribe: {
    title: "Napisać, gdy pojawią się nowe prompty?",
    text: "Katalog rośnie partiami po dwadzieścia-trzydzieści. Zostaw e-mail — napiszę przy następnej.",
    placeholder: "Twój e-mail",
    button: "Zapisz się",
    ok: "Gotowe. Napiszę, gdy katalog się powiększy.",
    already: "Ten adres już jest na liście — nic nie trzeba robić.",
    invalid: "Sprawdź adres: wygląda na literówkę.",
    error: "Nie udało się zapisać. Spróbuj jeszcze raz za chwilę.",
    promise: "Tylko o nowych promptach, najwyżej kilka razy w miesiącu. Wypisanie jednym kliknięciem z każdego e-maila.",
    leaveTitle: "Wypisanie",
    leaveDone: "Gotowe, więcej e-maili nie będzie.",
    leaveFailed: "Ten link nie zadziałał. Może już się wypisałeś — albo adres został ucięty.",
    leaveBack: "Strona główna",
  },
  catalog: {
    promptWord: {
      one: "prompt",
